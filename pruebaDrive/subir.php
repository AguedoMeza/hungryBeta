...
function subirArchivo($archivoParaSubir, $tituloDeDoc){
    ...
    $metaDatos = new Google_Service_Drive_DriveFile(array('name' => $tituloDeDoc, "parents" => ["0Bwm2Ldo84ZjpWUJLUDJJNlVDR3c"])); // normalmente es algo así 1HeqmBX-1Lsy8dMAjmUY-Bjufvfsadf
    switch ($mimeType) {
