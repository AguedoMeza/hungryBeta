...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="indexMaestroContenido.php"> <i class="menu-icon fa fa-dashboard"></i>Panel de Super Usuario</a>
                    </li>
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success"></span> Listado de Departamentos.
    ...
    $qry = "SELECT proyectos.id, nombre_proyecto, usuarios.usuario, descripcion, fecha_entrega, usuarios.usuario, proyectos.activo 
    FROM proyectos
    LEFT JOIN usuarios
    on usuarios.id = proyectos.id_usuario_asignado
    WHERE proyectos.id_departamento = '$id'";
